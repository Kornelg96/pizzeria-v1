      ...
      <div className={styles.extraDiv}>
          ...
          <div className={styles.productInfo}>
            ...
            <div className={styles.productSizes}>
              <div>
                ...
                />
                <label className={styles.label} htmlFor="35">
                  35cm - {pizza[0].prices[0]},00zł
                </label>
              </div>
              <div>
                <input
                  ...
                  checked={selected === "no"}
                />
                <label className={styles.label} htmlFor="45">
                  45cm - {pizza[0].prices[1]},00zł
                </label>
              </div>
              <div>
                <input
                ...
                />
                <label className={styles.label} htmlFor="55">
                  55cm - {pizza[0].prices[2]},00zł
                </label>
              </div>
            </div>
            ...
            <div className={styles.productIngredients}>
              ...
              <div className={styles.ingredientsWrapper}>
                <p className={styles.ingredients}>
                  {pizza[0].extraOptions.map((extra) => extra.text + `, `)}
                </p>
                  ...
                  <div className={styles.extraItemWrapper}>
                    {cat.subCategory.map((subCat, index) => (
                      <div key={index} className={styles.extraItem}>
                        ...
                        />
                        <label
                          className={styles.labelExtra}
                          htmlFor={subCat.subTitle}
                        >
                          {subCat.subTitle}
                        </label>
                      </div>
        ...
        <div className={styles.buttonsWrapper}>
          <button onClick={handleClick}>
            Dodaj do koszyka ({price * quantity} zł)
          </button>
        </div>
      </div>
    </div>
